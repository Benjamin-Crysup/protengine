...
cp includes_pro/*.h builds/inc_x64_linux
for v in source_pro/*.cpp; do g++ -pthread $v -O2 -Wall -Ibuilds/lib_x64_linux -Ibuilds/inc_x64_linux -c -o builds/objp_x64_linux/$(basename $v .cpp).o; done;
g++ -pthread -o builds/bin_x64_linux/Protengine builds/objp_x64_linux/*.o -Lbuilds/lib_x64_linux -lwhodun -lz -ldl

for v in source_pro_uti/*.cpp; do g++ -pthread -O2 -Wall -Ibuilds/lib_x64_linux -o builds/bin_x64_linux/$(basename $v .cpp) $v -Lbuilds/lib_x64_linux -lwhodun -lz -ldl; done

cp scripts_pro/*.py builds/bin_x64_linux
cp scripts_pro/*.m4 builds/bin_x64_linux
